                            ...
                            <div className="container">
                                ...
                                <div className="col-3 pt-2 pb-1">
                                    <Link to={`/decks/${deckId}/cards/${card.id}/edit`}>
                                        <button className="btn btn-secondary mr-1"><i className="bi bi-pencil mr-1"></i>Edit</button>
                                    </Link>
                                    <button onClick={handleCardDelete} value={card.id} className="btn btn-danger"><i value={card.id}className="bi bi-trash"></i>Delete</button>
                                </div>
                            </div>
                        </div>
                    </div>
